...
namespace Palmmedia.WpfGraph.UI.Elements3D
{
    ...
    internal class RegularEdgeUIElement<TNodeType, TEdgeType> : EdgeUIElement<TNodeType, TEdgeType>
        ...
        where TEdgeType : EdgeData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RegularEdgeUIElement&lt;TNodeType, TEdgeType&gt;"/> class.
        /// </summary>
        ...
        public RegularEdgeUIElement(Edge<TNodeType, TEdgeType> edge, TranslateTransform3D translateTransform1, TranslateTransform3D translateTransform2)
            : base(edge)
        {
